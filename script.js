...
// Webhook URL for item request notifications
var ITEM_REQUEST_WEBHOOK = 'https://hook.us2.make.com/r89wvo5dd3ujv0tol8onx9xoir1p7kpa';
...
// Send email notification to Hayden via Make.com
fetch(ITEM_REQUEST_WEBHOOK, {
method: 'POST',
headers: { 'Content-Type': 'application/json' },
body: JSON.stringify({
type: 'item_request',
customerName: name,
requestSocial: social,
requestDetails: details + (type ? ' | Type: ' + type : ''),
requestText: request
})
}).catch(function() {}); // fail silently — toast already shown
